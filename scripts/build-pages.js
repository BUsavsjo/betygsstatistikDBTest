...
console.log('Included: index.html, app/, public data/processed if present, and data/demo.');
console.log('Excluded: server.js, data/raw, all data/output, documentation, exports and dependencies.');
